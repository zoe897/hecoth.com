...
<div class="bg-gray-50 p-6 md:p-8 rounded-2xl border border-gray-200 my-10">
  <div class="flex flex-col items-center text-center">
    ...
    <div class="flex flex-wrap justify-center items-center gap-2 font-mono text-sm md:text-base font-bold mb-8 text-white">
      <div class="bg-green-600 px-3 py-1.5 rounded shadow-sm">TYPE</div>
      <span class="text-gray-400"> - </span>
      <div class="bg-blue-600 px-3 py-1.5 rounded shadow-sm">OD</div>
      <span class="text-gray-400"> - </span>
      <div class="bg-blue-600 px-3 py-1.5 rounded shadow-sm">T</div>
      <span class="text-gray-400"> - </span>
      <div class="bg-orange-500 px-3 py-1.5 rounded shadow-sm">EDGE</div>
      <span class="text-gray-400"> - </span>
      <div class="bg-orange-500 px-3 py-1.5 rounded shadow-sm">NOTCH</div>
      <span class="text-gray-400"> - </span>
      <div class="bg-gray-700 px-3 py-1.5 rounded shadow-sm">HOLE</div>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 w-full text-left text-xs border-t border-gray-200 pt-6">
      ...
      <div>
        ...
        <p class="text-gray-600 m-0">OD: 10" - 38"<br>T: 3mm - 12mm<br>FS: Flat Size</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p class="text-gray-600 m-0">PCD: Pitch Circle<br>ID: Center Hole<br>NH: No. of Holes</p>
      </div>
    </div>
  </div>
</div>
...
| **Soil Type** | Soft to Medium | **Rocky / Hard Clay** |
...
Custom shapes and oblique concave designs. These are engineered for sustainable farming practices, such as effective straw management.
...
* **Global Compatibility:** Fully compatible with major brands including John Deere, Kuhn, and Massey Ferguson.
...
<a href="mailto:zoe@annetop.com?subject=Inquiry for Disc Blades" class="inline-block bg-green-600 text-white px-6 py-3 rounded-lg no-underline font-bold hover:bg-green-700 transition my-4">Get a Wholesale Quote Now</a>